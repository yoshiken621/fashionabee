...
ActiveRecord::Schema.define(version: 2022_06_15_062614) do
  ...
  create_table "advisers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "rooms", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["adviser_id"], name: "index_rooms_on_adviser_id"
